...
import io.inversion.context.ContextTest;
...
public class WiringTest {
    ...
    @Test
    public void test_api_encoding(){
        Engine  e   = new Engine();
        Context context = e.getContext();

        DbAction dbAction = (DbAction)new DbAction().withName("dbAction");
        Db       db   = new BooksDb().withName("db");
        Endpoint ep = new Endpoint("GET,[books]/[{bookKey}]/*", dbAction).withName("ep");
        ...
        ContextTest.assertEncodeDecodeEncodeMatches(context, api, null);
    }
    ...
    public void test_findFile(){
        String path = "io/inversion/context/codeWiredApiGetsConfigged/inversion1.properties";
    ...
    public void test_propWiredMultipleApis() {
        Engine e = new Engine("io/inversion/context/propWiredMultipleApis", "dev");
        e.startup();
    ...
    public void test_profileOverrides() {
        ...
        Engine dev = new Engine("io/inversion/context/profileOverrides", "dev");
        dev.startup();
        ...
        Engine prod = new Engine("io/inversion/context/profileOverrides", "prod");
        prod.startup();
    ...
    public void test_propWiredInvalidName_Ignored() {
        Engine e = new Engine();
        e.withConfigPath("io/inversion/context/propWiredInvalidName");
        e.startup();
    }
...
//    }
    ...
    public void test_codeWiredApiGetsConfigged() {
        ...
        Engine e = new Engine().withApi(api);
        e.withConfigPath("io/inversion/context/codeWiredApiGetsConfigged");
        e.startup();
    ...
    public void test_propWiredObjectNameAlreadyExits_throwsException() {
        try {
            ...
            Engine     e      = new Engine().withApi(api);
            e.withConfigPath("io/inversion/context/propWiredObjectNameAlreadyExits");
            e.startup();
        } catch (Exception ex) {
            ex.printStackTrace();
            System.out.println("---------");
