...
public class ElasticsearchGetHandler implements Handler
{
    ...
    * @return
    */
   private JSObject buildMeta(int size, int pageNum, int totalHits, String apiUrl, ElasticQuery dsl, Object sources, String elasticUrl, List<String> headers)
   {
   ...
   private JSArray createDataJsArray(boolean isAll, boolean isOneSrcArr, JSArray hits, ElasticQuery dsl)
   {
      JSArray data = new JSArray();
