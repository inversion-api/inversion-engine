...
public class ElasticsearchRql extends Rql<Table, ElasticsearchQuery>
{
   static
   {
      Rql.addRql(new ElasticsearchRql());
   }

   public static final int MAX_NORMAL_ELASTIC_QUERY_SIZE = 10000;

   private ElasticsearchRql()
   {
      super("elastic");
   }

   public ElasticsearchQuery buildQuery(Table table, Object queryParams)
   {
      ElasticsearchQuery query = new ElasticsearchQuery(table);
