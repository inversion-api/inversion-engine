...
public class ElasticRql extends Rql
{
   ...
   public QueryDsl toQueryDsl(Map<String, String> params) throws Exception
   {
      ...
      io.rocketpartners.cloud.rql.elastic.Order elasticOrder = null;
      ...
      for (int i = 0; i < orderList.size(); i++)
      {
         ...
         if (elasticOrder == null)
            elasticOrder = new io.rocketpartners.cloud.rql.elastic.Order(Parser.dequote(order.col), order.dir);
         else
