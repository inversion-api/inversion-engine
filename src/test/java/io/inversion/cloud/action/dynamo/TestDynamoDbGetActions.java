...
public class TestDynamoDbGetActions extends TestRestGetActions
{
   ...
   public void testH() throws Exception
   {
      ...
      res = engine.get("northwind/dynamodb/orders?eq(OrderId, 11058)&sw(type, 'ORD')&eq(shipcity,Mannheim)").statusOk();
      res.dump();
   ...
   public void testI() throws Exception
   {
      ...
      res = engine.get("northwind/dynamodb/orders?eq(OrderId, 11058)&eq(employeeId,9)").statusOk();
      res = engine.get("northwind/dynamodb/orders?eq(OrderId, 11058)&sw(type, 'ORD')&eq(employeeId,9)&eq(OrderDate,'2014-10-29T00:00-0400')").statusOk();
   ...
   public void testK() throws Exception
   {
      ...
      res = engine.get("northwind/dynamodb/orders?gt(OrderId, 1)&eq(type, ORDER)").statusOk();
