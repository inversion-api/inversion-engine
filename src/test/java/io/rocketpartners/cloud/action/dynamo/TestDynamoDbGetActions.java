 ...
 */
public class TestDynamoDbGetActions extends TestCase
{
   ...
   public void test0() throws Exception
   {
      ...
      res = service.get("northwind/dynamodb/orders?limit=5");
      json = res.getJson();
      System.out.println(res.getDebug());

      assertEquals(5, json.getArray("data").length());
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: ScanSpec maxPageSize=5 scanIndexForward=true nameMap={} valueMap={} keyConditionExpression='' filterExpression='' projectionExpression=''");
   ...
   public void testA() throws Exception
   {
      ...
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: ScanSpec maxPageSize=100 scanIndexForward=true nameMap={#var1=ls2} valueMap={:val1=Blauer See Delikatessen} keyConditionExpression='' filterExpression='#var1 = :val1' projectionExpression=''");
   }
   ...
   public void testC() throws Exception
   {
      ...
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: QuerySpec:'Primary Index' maxPageSize=100 scanIndexForward=true nameMap={#var1=hk} valueMap={:val1=11058} keyConditionExpression='#var1 = :val1' filterExpression='' projectionExpression=''");
   }
   ...
   public void testD() throws Exception
   {
      ...
      assertEquals(json.getArray("data").length(), 1);
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: GetItemSpec partKeyCol=hk partKeyVal=11058 sortKeyCol=sk sortKeyVal=ORDER");
   ...
   public void testE() throws Exception
   {
      ...
      assertEquals(json.getArray("data").length(), 1);
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: QuerySpec:'Primary Index' maxPageSize=100 scanIndexForward=true nameMap={#var1=hk, #var2=sk} valueMap={:val1=11058, :val2=AAAAA} keyConditionExpression='#var1 = :val1 and #var2 > :val2' filterExpression='' projectionExpression=''");
   }
   ...
   public void testF() throws Exception
   {
      ...
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: QuerySpec:'Primary Index' maxPageSize=100 scanIndexForward=true nameMap={#var1=hk, #var2=sk, #var3=ls1} valueMap={:val1=12345, :val2=AAAAA, :val3=A} keyConditionExpression='#var1 = :val1 and #var2 > :val2' filterExpression='#var3 > :val3' projectionExpression=''");
   }
   ...
   public void testG() throws Exception
   {
      ...
      assertEquals(json.getArray("data").length(), 1);
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: QuerySpec:'Primary Index' maxPageSize=100 scanIndexForward=true nameMap={#var1=hk} valueMap={:val1=11058, :val2=ORD} keyConditionExpression='#var1 = :val1 and begins_with(sk,:val2)' filterExpression='' projectionExpression=''");
   }
   ...
   public void testH() throws Exception
   {
      ...
      assertEquals(json.getArray("data").length(), 1);
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: QuerySpec:'ls1' maxPageSize=100 scanIndexForward=true nameMap={#var1=hk, #var2=ls1} valueMap={:val1=11058, :val2=Mannheim, :val3=ORD} keyConditionExpression='#var1 = :val1 and #var2 = :val2' filterExpression='begins_with(sk,:val3)' projectionExpression=''");
   }
   ...
   public void testK() throws Exception
   {
      ...
      //assertEquals(json.getArray("data").length(), 1);
      TestDynamoDb.assertDebug(res, "DynamoDbQuery: ScanSpec maxPageSize=100 scanIndexForward=true nameMap={#var1=sk, #var2=hk} valueMap={:val1=ORDER, :val2=1} keyConditionExpression='' filterExpression='#var1 = :val1 and #var2 > :val2' projectionExpression=''");
   }
