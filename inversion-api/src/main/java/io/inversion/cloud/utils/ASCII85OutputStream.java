 ...
 */
public class ASCII85OutputStream extends FilterOutputStream implements ASCII85Constants
{
   ...
   private byte[] convertWord(long word)
   {
      ...
      else
      {
         ...
         byte c3 = (byte) (((word - (c1 * POW85[0]) - (c2 * POW85[1])) / POW85[2]) & 0xFF);
         byte c4 = (byte) (((word - (c1 * POW85[0]) - (c2 * POW85[1]) - (c3 * POW85[2])) / POW85[3]) & 0xFF);
         byte c5 = (byte) (((word - (c1 * POW85[0]) - (c2 * POW85[1]) - (c3 * POW85[2]) - (c4 * POW85[3]))) & 0xFF);

         byte[] ret = {(byte) (c1 + START), (byte) (c2 + START), (byte) (c3 + START), (byte) (c4 + START), (byte) (c5 + START)};
