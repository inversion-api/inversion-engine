...
//     */
//    protected List<String> upsert(Request req, Collection collection, List<JSMap> nodes) {
//        //--
//        //--
...
//
//
//    protected void swapRefsWithActualReferences(JSMap root){
...
//    }
//
//    protected void swapLogicalDuplicateReferences(Collection childColl, JSMap child, JSMap parent, String parentProp, Map<Collection, Map<String, JSNode>> visited){
//        if(child == null)
//            return;
//
