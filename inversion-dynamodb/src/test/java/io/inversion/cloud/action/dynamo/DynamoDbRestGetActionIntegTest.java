...
import io.inversion.cloud.action.rest.AbstractRestActionIntegTest;
 ...
 * @see README.md
 */
public class DynamoDbRestGetActionIntegTest extends AbstractRestActionIntegTest
{
   ...
   public void initializeDb()
   {
      ...
      if (db == null)
      {
         db = new DynamoDb().withName("dynamo");
         setDb(db);
      }
   }
   ...
   {
      return null;//DynamoDbEngineFactory.service();
   }
