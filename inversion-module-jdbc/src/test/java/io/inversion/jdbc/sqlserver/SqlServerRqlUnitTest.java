...
public class SqlServerRqlUnitTest extends AbstractSqlQueryRqlTest {
    ...
    public SqlServerRqlUnitTest() throws Exception {
        ...
        withExpectedResult("includes", "SELECT \"orders\".\"shipCountry\", \"orders\".\"shipCity\" FROM \"orders\" ORDER BY \"orders\".\"shipCountry\" ASC, \"orders\".\"shipCity\" ASC OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        ...
        withExpectedResult("count1", "SELECT COUNT(*) FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("count2", "SELECT COUNT(?) FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[1]");
        withExpectedResult("count3", "SELECT COUNT(\"orders\".\"shipRegion\") FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("countAs", "SELECT COUNT(*) AS \"countOrders\" FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("sum", "SELECT SUM(\"orders\".\"freight\") FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("sumAs", "SELECT SUM(\"orders\".\"freight\") AS \"Sum Freight\" FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("sumIf", "SELECT SUM(CASE WHEN \"orders\".\"shipCountry\" = ? THEN 1 ELSE 0 END) AS \"French Orders\" FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[France]");
        withExpectedResult("min", "SELECT MIN(\"orders\".\"freight\") FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("max", "SELECT MAX(\"orders\".\"freight\") FROM \"orders\" OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
        withExpectedResult("groupCount", "SELECT \"orders\".\"shipCountry\", COUNT(*) AS \"countryCount\" FROM \"orders\" GROUP BY \"orders\".\"shipCountry\" ORDER BY \"orders\".\"shipCountry\" ASC, \"orders\".\"countryCount\" ASC OFFSET 0 ROWS FETCH NEXT 100 ROWS ONLY args=[]");
