...
CREATE UNIQUE INDEX `UserRole_uratc` ON `UserRole` (`userId`,`roleId`,`apiCode`,`tenantCode`);
...
CREATE UNIQUE INDEX `UserGroup_ugatc` ON `UserGroup` (`userId`,`groupId`,`apiCode`,`tenantCode`);
...
CREATE UNIQUE INDEX `GroupRole_ugatc` ON `GroupRole` (`groupId`,`roleId`,`apiCode`,`tenantCode`);
...
CREATE UNIQUE INDEX `UserPermission_upatc` ON `UserPermission` (`userId`,`permissionId`,`apiCode`,`tenantCode`);
...
CREATE UNIQUE INDEX `GroupPermission_upatc` ON `GroupPermission` (`groupId`,`permissionId`,`apiCode`,`tenantCode`);
...
CREATE UNIQUE INDEX `RolePermission_upatc` ON `RolePermission` (`roleId`,`permissionId`,`apiCode`,`tenantCode`);
